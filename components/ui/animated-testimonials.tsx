...
export const AnimatedTestimonials = ({
  ...
  // Use a consistent rotation value for server rendering
  // Only use random values on the client
  const getRotation = (index: number) => {
    if (!isClient) {
      // Deterministic value for server rendering
      return (index * 3) % 10 - 5;
    }
    // Random value for client rendering, only used after hydration
